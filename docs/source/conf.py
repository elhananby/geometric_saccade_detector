...
project = 'The Geometric Saccade Detector'
...
latex_documents = [
  ('index', 'geometric_saccade_detector.tex', 'geometric_saccade_detector Documentation',
   'Andrea Censi', 'manual'),
]
...
man_pages = [
    ('index', 'The Geometric Saccade Detector', 'geometric_saccade_detector Documentation',
     ['Andrea Censi'], 1)
]
